...
set "ENNEA=%PAYLOADS%\ennea\8635-Ennea.img"

title Ximi Unlock BL - Snapdragon 8s / 7+ Gen 3 High Version (SM8635)

echo %CYN%=================================================================%RST%
echo  Ximi Tool Lite - Unlock BL Snapdragon 8s / 7+ Gen 3 (SM8635) - HIGH VERSION
echo  Ho tro: Redmi Turbo 3 / Xiaomi Civi 4 Pro / Xiaomi Pad 7 Pro
...
if "%choice%"=="1" ( set "factoryImages=Redmiturbo3"    & set "unlockGPT=Redmiturbo3"    & set "bin=8sg3or7pg3" )
if "%choice%"=="2" ( set "factoryImages=Xiaomicivi4pro" & set "unlockGPT=Xiaomicivi4pro" & set "bin=8sg3or7pg3" )
if "%choice%"=="3" ( set "factoryImages=Xiaomipad7pro"  & set "unlockGPT=Xiaomipad7pro"  & set "bin=Xiaomipad7pro" )
