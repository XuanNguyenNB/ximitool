...
set "ENNEA=%PAYLOADS%\ennea\8735-Ennea.img"

title Ximi Unlock BL - Snapdragon 8s Gen 4 (SM8735)

echo %CYN%=================================================================%RST%
echo  Ximi Tool Lite - Unlock Bootloader Snapdragon 8s Gen 4 (SM8735)
echo  Ho tro: Redmi Turbo 4 Pro / Xiaomi Civi 5 Pro / Xiaomi Pad 8
echo.
...
if "%choice%"=="1" ( set "factoryImages=Redmiturbo4pro" & set "unlockGPT=Redmiturbo4pro" )
if "%choice%"=="2" ( set "factoryImages=Xiaomicivi5pro" & set "unlockGPT=Xiaomicivi5pro" )
if "%choice%"=="3" ( set "factoryImages=Xiaomipad8"     & set "unlockGPT=Xiaomipad8" )
...
"%ADB%" push "%abl_path%" /data/local/tmp/abl
if %errorlevel% neq 0 (
