...
title Ximi Unlock BL - Snapdragon 8s/7+ Gen 3 (SM8635)

echo %CYN%=================================================================%RST%
echo  Ximi Tool Lite - Unlock Bootloader Snapdragon 8s/7+ Gen 3 (SM8635)
...
if "%choice%"=="1" ( set "factoryImages=Redmiturbo3"     & set "unlockGPT=Redmiturbo3" )
if "%choice%"=="2" ( set "factoryImages=Xiaomicivi4pro"  & set "unlockGPT=Xiaomicivi4pro" )
if "%choice%"=="3" ( set "factoryImages=Xiaomipad7pro"   & set "unlockGPT=Xiaomipad7pro" )
