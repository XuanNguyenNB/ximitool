...
set "ENNEA=%PAYLOADS%\ennea\8550-Ennea.img"

title Ximi Unlock BL - Snapdragon 8 Gen 2 (SM8550)

echo %CYN%=================================================================%RST%
echo  Ximi Tool Lite - Unlock Bootloader Snapdragon 8 Gen 2 (SM8550)
echo  Ho tro: Redmi K60 Pro / K70 / Xiaomi 13 / 13 Pro / 13 Ultra / Pad 6s Pro
echo.
...
if "%choice%"=="1" ( set "factoryImages=Redmik60pro"   & set "unlockGPT=Redmik60pro" )
if "%choice%"=="2" ( set "factoryImages=Redmik70"      & set "unlockGPT=Redmik70" )
if "%choice%"=="3" ( set "factoryImages=Xiaomi13"      & set "unlockGPT=Xiaomi13" )
if "%choice%"=="4" ( set "factoryImages=Xiaomi13pro"   & set "unlockGPT=Xiaomi13pro" )
if "%choice%"=="5" ( set "factoryImages=Xiaomi13ultra" & set "unlockGPT=Xiaomi13ultra" )
if "%choice%"=="6" ( set "factoryImages=Xiaomipad6spro" & set "unlockGPT=Xiaomipad6spro" )
